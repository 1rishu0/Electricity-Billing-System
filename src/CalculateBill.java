        ...
        if(ae.getSource()==b1){
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    total_bill+= Integer.parseInt(rs.getString("services_charge"));
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null,"Customer Bil Updated Successfully");
                this.setVisible(false);
            }catch(Exception aae){aae.printStackTrace();}
