...
public class Login extends JFrame implements ActionListener {
    ...
    Login() {
        ...
        add(b1);
//        a java program is made up of anumber of custom classes written by programmer like up and those classess 
//                whcih ocme pre packaged with java. when a program is executed, JVM needs to load the content
//                        to all the needed class. JVM uses a CLASSLOADER to find the classes
